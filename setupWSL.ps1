...
function Install-WSL {
    ...
    wsl -d Ubuntu -u root -- 'apt install -y gnome-terminal '
    ...
    wsl -d Ubuntu -u root -- 'apt remove docker docker-engine docker.io containerd runc'
    wsl -d Ubuntu -u root -- 'apt update'
    wsl -d Ubuntu -u root -- 'apt install -y ca-certificates curl gnupg '
    ...
    wsl -d Ubuntu -u root -- 'apt update'
    wsl -d Ubuntu -u root -- 'apt install -y docker-ce docker-ce-cli containerd.io docker-buildx-plugin docker-compose-plugin'
